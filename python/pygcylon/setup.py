...
_include_dirs = [cylon_include_dir,
                 # libcudf-bundled RAPIDS headers first (Thrust, CCCL, etc.)
                 os.path.join(conda_include_dir, "libcudf/rapids"),
...
setup(
    ...
    python_requires='>=3.7',
    install_requires=["cython", "numpy", "llama-index-core", "langchain-text-splitters", "chromadb"],  # cudf must be installed via conda
    zip_safe=False,
)
